...
class TestFileStorage(unittest.TestCase):
    ...
    @unittest.skipIf(models.storage_t == "db", "not testing file storage")
    def test_get_existent_object(self):
        """Test that gets a loaded object from file.json"""
        storage = FileStorage()
        new_user = User()
        storage.new()
        storage.save()
    ...
    def test_get_nonexisting_object(self):
        """Test that gets a non existing object from file.json"""
        retrieved_user = FileStorage().get(User, "nonexistent")
        self.assertIsNone(retrieved_user)

    @unittest.skipIf(models.storage_t == "db", "not testing file storage")
    def test_count_specific_class(self):
        """Test that queries that number of records of a class"""
        storage = FileStorage()
